...
Determine those libraries eligible for Category 2 funding that would not require filtering due to the type of Category 1 purpose they utilize
Related to this would be then determining how many Cat 2 dollars have been left on the table from those libraries 
Also related to this is how many of these libraries are participating in a consortium that makes it easy to apply for Cat 1 services but doesn’t deal with Cat 2 services?
E-mail with Bob Bocher on 05/18/2022   	
So, if I were trying to get to an answer around that question about filtering being a barrier to utilization of Category 2 funding, we would need to understand and answer the following question to start with:
How many libraries are utilizing Category 1 services for these purposes #1-4?
How many libraries are utilizing Category 1 services for purposes #5-6, but are not utilizing Category 2 funding?

Purpose Types pulled from this dataset in the Purpose Type field - https://opendata.usac.org/E-rate/E-Rate-Request-for-Discount-on-Services-FRN-Line-I/hbj5-2bpj

Service purpose for the FRN Line Item. It can be used to filter the records of a particular type of purpose. There are six purposes:
NO FILTERING REQUIRED
Applicant owned fiber network, eligible fiber electronics, or maintenance & operations
...
# Read in 2022 cat2 erate data
cat2_2022 <-
  s3read_using(
    FUN = read.csv,
    na.strings = c("", " ", "N/A", "n/a"),
    object = "2022_Libraries_Funded_Committed_Category_2.csv",
    bucket = "erate-data/data/AVI8-SVP9_Commitments"
  )
