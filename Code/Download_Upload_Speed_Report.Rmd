...
output: pdf_document
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), paste0("Download_Speeds_by_State_for_Marijke_Report_", Sys.Date(), ".pdf"))) })
---
