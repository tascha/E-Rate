...
erate_imls <- s3read_using(FUN = read.csv, object = "data/AVI8-SVP9_Commitments/erate_imls_compact.csv", bucket = "erate-data")

ae_and_outlets <- s3read_using(FUN = read.csv, object = "data/IMLS_AE_and_Outlets_combined_dataset.csv", bucket = "erate-data")
ae_and_outlets <- ae_and_outlets %>% select(-X)
